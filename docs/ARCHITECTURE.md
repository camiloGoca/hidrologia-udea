...
Quedan para fases futuras: búsqueda avanzada/autocomplete de hashtags, redirects si alguna vez se permite cambiar slugs, vista previa editorial, copia explícita de QuestionAttachment hacia Post, versionado/historial y autosave.
